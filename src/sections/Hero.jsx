...
//
//           <div>
//             <button className="aesthetic-shimmer-button"  >
//               <div className="flex items-center gap-2">
//                 <p className="text-sm font-light tracking-[0.19rem] uppercase text-gray-700 flex items-center gap-2">
//                   get your book now {open ? "yes" : "no"}
//                   <svg xmlns="" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right">
//                     <path d="M5 12h14" />
//                     <path d="m12 5 7 7-7 7" />
//                   </svg>
//                 </p>
...
//           {/* <ModalComponent /> */}
//
//           {/* <button class="aesthetic-shimmer-button "> */}
//           {/*   <div className="flex  gap-2  "> */}
//           {/*     <p className={`text-sm font-light tracking-[0.19rem] uppercase ${textColor} relative`}> */}
//           {/*       get your book now */}
